...
%PLOTS = (
  ...
  bynode => {
    ...
    data_reader => sub { &DSC::extractor::read_data(@_, "start_time", "node_id"); },
    plot_type	=> 'trace',
  ...
  qtype => {
    ...
    names	=> $qtype_names,
    colors	=> $qtype_colors,
    data_reader => sub { &DSC::extractor::read_data(@_, "start_time", "key1"); },
    plot_type	=> 'trace',
    yaxes	=> $std_trace_yaxes,
  ...
  certain_qnames_vs_qtype => {
    ...
    data_reader => sub { &DSC::extractor::read_data(@_, "start_time", "key1", "key2"); },
    plot_type	=> 'trace',
    yaxes	=> $std_trace_yaxes,
    munge_func  => sub {
  ...
  client_subnet_accum => {
    ...
    data_reader => sub { &DSC::extractor::read_data(@_, "key1"); },
