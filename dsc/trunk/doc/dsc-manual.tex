...
hard-coded.  The top-level directory structure is as follows:

\begin{verbatim}
% ls -l dsc
-rw-r--r--  1 wessels  wessels  159 Mar 14 14:21 COPYRIGHT
drwxr-xr-x  6 wessels  wessels  512 Mar 14 13:40 collector
drwxr-xr-x  3 wessels  wessels  512 Mar 14 15:01 doc
drwxr-xr-x  7 wessels  wessels  512 Mar 14 13:49 presenter
\end{verbatim}
...
Alternatively you can manually copy the {\em dsc\/} binary,
\path|dsc.conf.sample| file to a location of your choosing.
