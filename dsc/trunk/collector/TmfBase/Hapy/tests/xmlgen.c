...
/*  According to http://www.xml-benchmark.org/
    the source code of the data generator XMLgen is public domain.

    This code is distributed with Hapy for convenience, until 
    the XMark project incorprorates bug fixes and improvements
